...
SMART_QUESTION_BANK: dict[str, list[ClarificationQuestion]] = {
    "pain_red_flags": [
        ...
        ClarificationQuestion(
            ...
            question=(
                "Do you have numbness, weakness, swelling, or the area "
                "feels cold/blue?"
            ),
            options=[
                "Numbness/tingling",
    ...
    "neurology": [
        ClarificationQuestion(
            id="neuro_deficit",
            question=(
                "Do you have weakness, numbness, facial droop, confusion, "
                "or trouble speaking?"
            ),
            options=[
                "Weakness",
    ...
    "gastroenterology": [
        ...
        ClarificationQuestion(
            id="gi_red_flags",
            question=(
                "Do you have vomiting blood, black stools, yellow eyes/skin, "
    ...
    "dermatology": [
        ClarificationQuestion(
            ...
            question=(
                "Is the rash spreading quickly, painful, blistering, "
                "or purple and non-fading?"
            ),
            options=[
                "Spreading quickly",
                "Painful",
