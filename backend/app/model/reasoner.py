    ...
    def _build_prompt(
        ...
        *,
        ...
        return (
            ...
            "- Use retrieved evidence ONLY when it clearly matches the patient's symptoms and context.\n"
            "- If a retrieved article is weakly related, irrelevant, or conflicts with the symptoms, ignore it.\n"
            "- Do not list a condition only because it appears in retrieved evidence; the patient's symptoms must fit.\n"
            "- If evidence is insufficient, say what is uncertain and keep the differential broad.\n"
